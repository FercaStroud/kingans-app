        ...
        <f7-page>
          ...
          <f7-list :style="{
            ...
            <f7-list-item class="custom-btn" flat link="/"
                          ...
                          panel-close>
              <f7-icon class="active" style="" material="home"></f7-icon>
              <span class="active" style="
                                    font-size: 1.2em;
                            ">Home</span>
            </f7-list-item>
            <f7-list-item class="custom-btn" flat
                          @click="openBrowser('https://kingans.com/menu/')"
                          v-ripple
                          panel-close>
              <f7-icon  style="" material="favorite"></f7-icon>
              <span  style="font-size: 1.2em;">Menú</span>
            </f7-list-item>
            <f7-list-item class="custom-btn" flat v-ripple
                          @click="openBrowser('http://kingans.com/pedido-sucursal/')"
                          panel-close>
              <f7-icon style="" material="shopping_cart"></f7-icon>
              <span style="
                                    font-size: 1.2em;
                            ">Pedido en Línea</span>
            </f7-list-item>
            <f7-list-item class="custom-btn" flat v-ripple
