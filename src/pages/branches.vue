    ...
    <f7-page>
        ...
        <f7-card class="elevation-2">
            <f7-card-content>
                ...
                <p>
                    <span style="font-size: .9em">TORREÓN</span><br/>
                    <span style="font-size: 1.6em">Independencia</span>
                </p>
                <p style="color: #6e6e74">
                    Blvd. Independencia #2295 <br/>
                    San Isidro, C.P. 27100, <br/>
                    Torreón, Coahuila.
                </p>
            </f7-card-content>
            <f7-card-footer>
        ...
        <f7-card class="elevation-2">
            <f7-card-content>
                ...
                <p>
                    <span style="font-size: .9em">TORREÓN</span><br/>
                    <span style="font-size: 1.6em">Colón</span>
                </p>
                <p style="color: #6e6e74">
                    Calz. Cristobal Colón #245 <br/>
                    Segundo de Cobián, C.P. 27100, <br/>
                    Torreón, Coahuila.
                </p>
            </f7-card-content>
            <f7-card-footer>
        ...
        <f7-card class="elevation-2">
            <f7-card-content>
                <img style="
                     ...
                     src="../assets/logoKingans.svg">
                <p>
                    <span style="font-size: .9em">SALTILLO</span><br/>
                    <span style="font-size: 1.6em">San Patricio</span>
                </p>
                <p style="color: #6e6e74">
                    Blvd. Pedro Figueroa #2990 <br/>
                    Residencial San Patricio, C.P. 25204, <br/>
                    Saltillo, Coahuila.
                </p>
            </f7-card-content>
            <f7-card-footer>
        ...
        <f7-card class="elevation-2">
            <f7-card-content>
                <img style="
                        ...
                        width: 40px; right: 8px;
                     " class="circle-image"
                     src="../assets/logoBakings.svg">
                <p>
                    <span style="font-size: .9em">TORREÓN</span><br/>
                    <span style="font-size: 1.6em">Plaza Real</span>
                </p>
                <p style="color: #6e6e74">
                    Blvrd. Independencia 3545 Ote <br/>
                    Residencial el Fresno, C.P. 27018, <br/>
                    Torreón, Coahuila.
                </p>
            </f7-card-content>
            <f7-card-footer>
